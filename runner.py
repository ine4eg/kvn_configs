...
from bridge import inject_runner_deps, create_bridge, _extract_download_mbps
...
async def main():
    ...
    # Initialize bridge dependencies before any cycle runs
    inject_runner_deps(log, make_xray_config, start_xray, parse_configs_file, get_label, TESTED_FILE)
